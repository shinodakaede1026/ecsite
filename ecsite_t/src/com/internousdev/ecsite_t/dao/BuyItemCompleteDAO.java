...
public class BuyItemCompleteDAO {
	...
	public void buyItemInfo(String item_transaction_id,String user_master_id,String total_price,
	    ...
	    String sql="INSERT INTO user_buy_item_transaction(item_transaction_id,total_price,total_count,user_master_id,pay,"
							+"insert_date)VALUES(?,?,?,?,?,?)";
			try{
...
//?=total_count
	public void update(String total_count) throws SQLException {
		DBConnector dbConnector1=new DBConnector();
		Connection connection1=dbConnector1.getConnection();
		String sql1= "UPDATE item_info_transaction "
				+ "SET item_stock = item_stock - ? "
				+ "WHERE item_name='Book'";
		PreparedStatement ps;
		try{
			ps=connection1.prepareStatement(sql1);
